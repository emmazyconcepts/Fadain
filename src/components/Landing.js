...
import Pic2 from "../assets/l1.png";
import Pic3 from "../assets/l2.png";
import Pic4 from "../assets/l3.png";
import Pic5 from "../assets/l4.png";
    ...
    <>
      ...
      <Bd4>
        ...
        <Boxx1>
          ...
          <B1>Excellect customer service</B1>
          <B2>
        ...
        <Boxx2>
          <img src={Pic2} alt="cta" width="10px" height="10px" />

          <B1>Be excellent to each other</B1>
          <B2>
          No games. No envy. We rely on our peers to improve. Be open, honest and kind.
          </B2>
        </Boxx2>
        <Boxx3>
          <img src={Pic3} alt="cta" width="10px" height="10px" />

          <B1>Pride in what we do</B1>
          <B2>
        ...
        <Boxx4>
          <img src={Pic4} alt="cta" width="10px" height="10px" />

          <B1>Do the impossible</B1>
          <B2>
          Be energized by difficult problems. Revel in unknowns. Ask "Why?", but always question, "Why not?"
          </B2>
        </Boxx4>
        <Boxx5>
          <img src={Pic5} alt="cta" width="10px" height="10px" />

          <B1>Be imaginative</B1>
          <B2>
          We believe the best products come from the best attention to detail. Be creative.
          </B2>
        </Boxx5>
      </Bd4>
    </>
